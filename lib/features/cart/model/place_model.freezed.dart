...
/// @nodoc
mixin _$CityModel {
  int get status => throw _privateConstructorUsedError; // Default to -1
...
// Default to -1
  ...
  @override
  String toString() {
    return 'CityModel(status: $status, data: $data)';
  }
...
abstract class _CityModel implements CityModel {
  const factory _CityModel({final int status, final Map<String, String> data}) =
      _$CityModelImpl;
