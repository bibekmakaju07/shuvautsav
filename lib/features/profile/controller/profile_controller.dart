...
final profileNotifierProvider = StateNotifierProvider.autoDispose<
    ProfileNotifier, AppState<DasboardOrdersDataModel, NetworkFailure>>((ref) {
  return ProfileNotifier();
});

class ProfileNotifier
    extends StateNotifier<AppState<DasboardOrdersDataModel, NetworkFailure>> {
  ...
  Future<void> getProfile() async {
    ...
    try {
      ...
      if (response is Response) {
        final data = DasboardOrdersDataModel.fromJson(response.data);
